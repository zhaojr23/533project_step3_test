...
import os
sys.path.append('../../')
from supermarket_system.product_management.purchase_management import purchase
from supermarket_system.product_management.records_management import record
